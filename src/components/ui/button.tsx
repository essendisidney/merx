...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border border-[var(--border)] bg-white text-[var(--ink)] hover:bg-[var(--surface)] disabled:opacity-50",
  ghost:
    "text-[var(--muted)] hover:bg-[var(--surface)] hover:text-[var(--ink)] disabled:opacity-50",
  danger:
